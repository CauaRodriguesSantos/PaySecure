/* clarity-js v0.7.66: https://github.com/microsoft/clarity (License: MIT) */ ! function() {
    "use strict";
    var t = Object.freeze({
            __proto__: null,
            get queue() {
                                ...
                                for (var u = 0; u < t.length; u++) {
                                    ...
                                    if (a = a || c >= 48 && c <= 57, r = r || 64 === c, i = 9 === c || 10 === c || 13 === c || 32 === c, 0 === u || u === t.length - 1 || i) {
                                        if (a || r) {
                                            ...
                                            s = p && null !== m ? s.match(m) ? s : S(s, "▪", "▫") : k(s), o.splice(e + 1 - n, s.length, s), n += s.length - 1
                                        }
                                        i && (a = !1, r = !1, e = u)
                                    }
                                }
    ...
    function S(t, e, n) {
        return O(), t ? t.replace(g, e).replace(v, n) : t
    }
    ...
    function C(t, e) {
        N.visible = "visible" === e ? 1 : 0, N.visible || I(t), T = !0
    }
    ...
    function H(t) {
        t in P || (P[t] = 0), t in z || (z[t] = 0), P[t]++, z[t]++
    }

    function W(t, e) {
        null !== e && (t in P || (P[t] = 0), t in z || (z[t] = 0), P[t] += e, z[t] += e)
    }

    function X(t, e) {
        null !== e && !1 === isNaN(e) && (t in P || (P[t] = 0), (e > P[t] || 0 === P[t]) && (z[t] = e, P[t] = e))
    }
    ...
    function J() {
        ...
        L = {
            gap: t - U
        }, Zr(25), L.gap < 3e5 ? V = Y(J, F) : Zi && (R("clarity", "suspend"), _o(), ["mousemove", "touchstart"].forEach((function(t) {
    ...
    function nt(t) {
        to() && o.lean && (o.lean = !1, et = {
            key: t
        }, Si(), Ei(), o.upgrade && o.upgrade(t), Zr(3))
    }
            ...
            return it(this, (function(o) {
                switch (o.label) {
                    case 0:
                        return i = {}, [4, ft(t)];
                    case 1:
                        return i.userId = o.sent(), i.userHint = a || ((u = t) && u.length >= 5 ? "".concat(u.substring(0, 2)).concat(S(u.substring(2), "*", "*")) : S(u, "*", "*")), st("userId", [(r = i).userId]), st("userHint", [r.userHint]), st("userType", [ht(t)]), e && (st("sessionId", [e]), r.sessionId = e), n && (st("pageId", [n]), r.pageId = n), [2, r]
                }
                var u
            }))
        }))
    ...
    function Mt(t, e, n) {
        o.fraud && null !== t && n && n.length >= 5 && (Et = {
            ...
            target: e,
            checksum: d(n, 28)
        }, Ot.indexOf(Et.checksum) < 0 && (Ot.push(Et.checksum), Ir(41)))
    }
    ...
    function Bt() {
        It = 1, Dt = [], jt = [], At = {}, Rt = [], Lt = [], Pt = "address,password,contact".split(","), zt = "password,secret,pass,social,ssn,code,hidden".split(","), Ht = "radio,checkbox,range,button,reset,submit".split(","), Wt = "INPUT,SELECT,TEXTAREA".split(","), Ct = new Map, Xt = new WeakMap, Yt = new WeakMap, qt = new WeakMap, Ut = new WeakMap, Tt = {}
    }
    ...
    function Gt(t, e) {
        ...
        var n = Xt.get(t);
        return !n && e && (n = It++, Xt.set(t, n)), n || null
    }
    ...
    function ce(t, e, n, a) {
        ...
        var r = jt.indexOf(t);
        r >= 0 && 1 === e && a ? (jt.splice(r, 1), jt.push(t)) : -1 === r && n && jt.push(t)
    }
    var se = Object.freeze({
            ...
            update: function(t, e, n, a) {
                ...
                if (r in Dt) {
                    ...
                    for (var h in n) Qt(s.data, n, h) && (u = !0, s.data[h] = n[h]);
                    $t(s), ce(r, a, u, c)
                }
            },
            updates: ie
    ...
    function ye() {
        var t = fe.shift();
        t && (he = t, t.task().then((function() {
            t.id === bi() && (t.resolve(), he = null, ye())
        })).catch((function(e) {
            t.id === bi() && (e && jr(0, 1, e.name, e.message, e.stack), he = null, ye())
        })))
    }
    ...
    function ke(t) {
        var e = performance.now(),
            n = Ee(t),
            a = e - de[n].start;
        W(t.cost, a), H(5), de[n].calls > 0 && W(4, a)
    }
    ...
    function Se(t) {
        return rt(this, void 0, void 0, (function() {
            ...
            return it(this, (function(a) {
                switch (a.label) {
                    case 0:
                        return (e = Ee(t)) in de ? (ke(t), n = de[e], [4, Oe()]) : [3, 2];
                    case 1:
    ...
    var Me, Ne = window.requestIdleCallback || function(t, e) {
    ...
    function nn(t) {
        switch (t.event) {
            ...
            case 19:
                ...
                }(n, t) && Ge.pop(), Ge.push(t), q(Ke), Ke = Y(an, 500, t.event);
                break;
            default:
    ...
    function cn() {
        ...
        }, un ? (q(on), on = Y(sn, 500, 11)) : (or(11), un = !0)
    }
    ...
    function vn(t) {
        ...
        if (null === t && 0 === i && 0 === o || null === i || null === o) return fn = h, void(hn = p);
        var g = dn.length,
            m = g > 1 ? dn[g - 2] : null;
        m && function(t, e) {
            var n = t.data.x - e.data.x,
        ...
        }(m, v) && dn.pop(), dn.push(v), q(pn), pn = Y(mn, 500, 10)
    }
    ...
    function Sn(t) {
        ...
        if (null !== e && !(null === e.anchorNode && null === e.focusNode || e.anchorNode === e.focusNode && e.anchorOffset === e.focusOffset)) {
            ...
            null !== wn && null !== bn.start && n !== e.anchorNode && (q(kn), En(21)), bn = {
                start: e.anchorNode,
                startOffset: e.anchorOffset,
                end: e.focusNode,
                endOffset: e.focusOffset
            }, wn = e, q(kn), kn = Y(En, 500, 21)
        }
    }
    ...
    function An() {
        ur = [], sr(), He(), Ye(), rn(), Be(), un = !1, Xi(window, "resize", cn), cn(), Xi(document, "visibilitychange", Dn), Dn(), dn = [], vn(), On(), Ce(), _n(), Xi(window, "pagehide", In)
    }
    ...
    function Rn(t) {
        ! function(t) {
            ...
            Xi(t, "cut", Xe.bind(this, 0), !0), Xi(t, "copy", Xe.bind(this, 1), !0), Xi(t, "paste", Xe.bind(this, 2), !0)
        }(t), function(t) {
            Xi(t, "mousedown", tn.bind(this, 13, t), !0), Xi(t, "mouseup", tn.bind(this, 14, t), !0), Xi(t, "mousemove", tn.bind(this, 12, t), !0), Xi(t, "wheel", tn.bind(this, 15, t), !0), Xi(t, "dblclick", tn.bind(this, 16, t), !0), Xi(t, "touchstart", en.bind(this, 17, t), !0), Xi(t, "touchend", en.bind(this, 18, t), !0), Xi(t, "touchmove", en.bind(this, 19, t), !0), Xi(t, "touchcancel", en.bind(this, 20, t), !0)
        }(t), function(t) {
            Xi(t, "input", Fe, !0)
        }(t), function(t) {
            Xi(t, "selectstart", Sn.bind(this, t), !0), Xi(t, "selectionchange", Sn.bind(this, t), !0)
        }(t), function(t) {
            Xi(t, "change", Ie, !0)
        }(t), function(t) {
            Xi(t, "submit", xn, !0)
    ...
    xn.dn = 16, In.dn = 17, Dn.dn = 18, An.dn = 8;
    var Ln = Object.freeze({
        __proto__: null,
        observe: Rn,
        start: An,
        stop: function() {
            ur = [], sr(), He(), Ye(), q(Ke), Ge.length > 0 && an(Ge[Ge.length - 1].event), q(qe), Be(), ln(), jn(), q(pn), dn = [], fn = null, hn = null, On(), q(kn), Ce(), _n(), Cn()
        }
    });
    ...
    function Qn() {
        if (zn = [], Vn = [], Bn = null, Gn = 0, Kn = {}, Zn = 0, null === Xn && (Xn = CSSStyleSheet.prototype.insertRule, CSSStyleSheet.prototype.insertRule = function() {
                return to() && ra(this.ownerNode), Xn.apply(this, arguments)
            }), "CSSMediaRule" in window && null === Un && (Un = CSSMediaRule.prototype.insertRule, CSSMediaRule.prototype.insertRule = function() {
                return to() && ra(this.parentStyleSheet.ownerNode), Un.apply(this, arguments)
            }), null === Yn && (Yn = CSSStyleSheet.prototype.deleteRule, CSSStyleSheet.prototype.deleteRule = function() {
                return to() && ra(this.ownerNode), Yn.apply(this, arguments)
            }), "CSSMediaRule" in window && null === Fn && (Fn = CSSMediaRule.prototype.deleteRule, CSSMediaRule.prototype.deleteRule = function() {
                return to() && ra(this.parentStyleSheet.ownerNode), Fn.apply(this, arguments)
            }), null === qn) {
                    ...
                    case 2:
                        ...
                        switch (i = e.target, u = o.throttleDom ? function(t, e, n, a) {
                            ...
                            if (r && "HTML" !== r.data.tag) {
                                ...
                                var h = Kn[f];
                                if (!1 === i && h[0] >= 10 && aa(h[2], 2, e, a), h[0] = i || d ? h[1] === n ? h[0] : h[0] + 1 : 1, h[1] = n, h[0] >= 10 || d) return h[2] = t.removedNodes, n > a + 3e3 ? t.type : (o.dropMutations || (Wn[f] = {
                                    mutation: t,
                                    timestamp: a
                                }), "throttle")
                            }
        ...
        return rt(this, void 0, void 0, (function() {
            ...
            return it(this, (function(f) {
                switch (f.label) {
                    ...
                    case 1:
                        if (!(Hn.length > 0)) return [3, 7];
                        e = Hn.shift(), n = s(), a = 0, r = e.mutations, f.label = 2;
                    case 2:
                    ...
                    case 8:
                        return u < c.length ? (l = c[u], d = Wn[l], delete Wn[l], [4, ta(t, d.mutation, s(), d.timestamp)]) : [3, 11];
                    case 9:
                    ...
                    case 11:
                        ...
                        }(), 0 === Object.keys(Wn).length && o ? [4, Xa(6, t, s())] : [3, 13];
                    case 12:
                        f.sent(), f.label = 13;
                    case 13:
                        return function() {
                            var t = s();
                            Object.keys(Kn).length > 1e4 && (Kn = {}, H(38));
        ...
        return rt(this, void 0, void 0, (function() {
            ...
            return it(this, (function(c) {
                switch (c.label) {
                    ...
                    case 1:
                        return i < r ? (o = t[i], 1 !== e ? [3, 2] : (Pn(o, n, e, a), [3, 5])) : [3, 6];
                    case 2:
    ...
    function ra(t) {
        return Vn.indexOf(t) < 0 && Vn.push(t), Bn && q(Bn), Bn = Y((function() {
            ! function() {
        ...
        for (var e = 0, n = Object.keys(t); e < n.length; e++) {
            ...
            if ("@type" === a && "string" == typeof r) switch (r = (r = r.toLowerCase()).indexOf("article") >= 0 || r.indexOf("posting") >= 0 ? "article" : r) {
                ...
                case "aggregaterating":
                    t.ratingValue && (X(11, ca(t.ratingValue, 100)), X(18, ca(t.bestRating)), X(19, ca(t.worstRating))), X(12, ca(t.ratingCount)), X(17, ca(t.reviewCount));
                    break;
                case "offer":
                    ci(7, t.availability), ci(14, t.itemCondition), ci(13, t.priceCurrency), ci(12, t.sku), X(13, ca(t.price));
                    break;
                case "brand":
                    ci(6, t.name)
            }
    ...
    function da(t, e, n) {
        ...
        switch (t.nodeType) {
            ...
            case Node.DOCUMENT_NODE:
                t === document && Jt(document), Oa(t, n), fa(t);
                break;
            ...
            case Node.ELEMENT_NODE:
                ...
                switch (o = t.parentElement ? t.parentElement : t.parentNode ? t.parentNode : null, "http://www.w3.org/2000/svg" === h.namespaceURI && (p = "svg:" + p), p) {
                    ...
                    case "IFRAME":
                        ...
                        }(M), N.attributes["*O"] = "true", M.contentDocument && M.contentWindow && "loading" !== M.contentDocument.readyState && (r = M.contentDocument)), se[i](t, o, N, e);
                        break;
                    case "LINK":
                        if (pi && "stylesheet" === v.rel) {
                            for (var T in Object.keys(document.styleSheets)) {
                                var x = document.styleSheets[T];
                                if (x.ownerNode == h) {
                                    var _ = {
                                        tag: "STYLE",
                                        attributes: v,
                    ...
                    default:
                        ...
                        h.shadowRoot && (r = h.shadowRoot), se[i](t, o, D, e)
                }
        }
        return r
    }
    ...
    function ha(t) {
        ...
        return (0 === e.length || n > 0 || t.id.length > 0) && (e = pa(t.sheet)), e
    }
    ...
    function pa(t) {
        ...
        try {
            ...
            if (jr(1, 1, t ? t.name : null), t && "SecurityError" !== t.name) throw t
        }
        if (null !== n)
    ...
    function Oa(t, e) {
        if (-1 === Ea.indexOf(t) && Ea.push(t), e = e || s(), null == t ? void 0 : t.adoptedStyleSheets) {
            X(36, 1);
            for (var n = [], a = 0, r = t.adoptedStyleSheets; a < r.length; a++) {
                var i = r[a],
                    o = fi.pageNum;
                i[wa] !== o && (i[wa] = o, i[ba] = Ni(), Na(e, i[ba], 0), Na(e, i[ba], 2, pa(i))), n.push(i[ba])
            }
            var u = Gt(t, !0);
            ka[u] || (ka[u] = []),
                function(t, e) {
                ...
                }(e, t == document ? -1 : Gt(t), 3, n), ka[u] = n, Sa[u] = e)
        }
    }
    ...
    function Xa(t, e, n) {
        return void 0 === e && (e = null), void 0 === n && (n = null), rt(this, void 0, void 0, (function() {
            var a, r, i, u, c, l, d, f, h, p, v, g, m, b, w, k, S, E, O, M, N, T, x, C, D, j, A, R, L;
            return it(this, (function(P) {
                switch (P.label) {
                    case 0:
                        ...
                        return [3, 12];
                    case 1:
                        return i = Me, r.push(i.width), r.push(i.height), _(t, i.width, i.height), kr(r), [3, 12];
                    case 2:
                    ...
                    case 3:
                        ...
                        for (h = 0, p = va; h < p.length; h++) m = p[h], (r = [m.time, m.event]).push(m.data.id), r.push(m.data.operation), r.push(m.data.cssRules), kr(r);
                        return Ma(), [3, 12];
                    case 4:
                        for (v = 0, g = Ta; v < g.length; v++) m = g[v], (r = [m.time, m.event]).push(m.data.id), r.push(m.data.operation), r.push(m.data.keyFrames), r.push(m.data.timing), r.push(m.data.timeline), r.push(m.data.targetId), kr(r);
                        return Pa(), [3, 12];
                    case 5:
                        ...
                        w = 0, k = b, P.label = 6;
                    case 6:
                        return w < k.length ? (S = k[w], 0 !== (E = be(e)) ? [3, 8] : [4, Se(e)]) : [3, 10];
                    case 7:
                        E = P.sent(), P.label = 8;
                    case 8:
                        if (2 === E) return [3, 10];
                        for (O = S.data, M = S.metadata.active, N = S.metadata.suspend, T = S.metadata.privacy, x = function(t) {
                                var e = t.metadata.privacy;
                                return "*T" === t.data.tag && !(0 === e || 1 === e)
                            }(S), C = 0, D = M ? ["tag", "attributes", "value"] : ["tag"]; C < D.length; C++)
                            if (O[j = D[C]]) switch (j) {
                                case "tag":
                                    A = Ya(S), R = x ? -1 : 1, r.push(S.id * R), S.parent && M && (r.push(S.parent), S.previous && r.push(S.previous)), r.push(N ? "*M" : O[j]), A && 2 === A.length && r.push("".concat("#").concat(qa(A[0]), ".").concat(qa(A[1])));
                                    break;
                                case "attributes":
                                    for (L in O[j]) void 0 !== O[j][L] && r.push(Ua(L, O[j][L], T));
                                    break;
                                case "value":
                                    Mt(S.metadata.fraud, S.id, O[j]), r.push(y(O[j], O.tag, T, x))
                            }
                        P.label = 9;
                    case 9:
                        return w++, [3, 6];
    ...
    function rr(t) {
        ...
        return Gn = s() + 3e3, Zn = s() + o.criticalMs, n && n.nodeType === Node.DOCUMENT_NODE ? n.documentElement : n
    }
    ...
    function or(t, e) {
        return void 0 === e && (e = null), rt(this, void 0, void 0, (function() {
            var n, a, r, i, o, u, c, l, d, f, h, p, v, g, m, w, k, S, E, O, M, N, T, x, I, D, j, A, R, L, P, z, H, W, X;
            return it(this, (function(Y) {
                switch (n = e || s(), a = [n, t], t) {
                    ...
                    case 19:
                    case 20:
                        for (r = 0, i = Ge; r < i.length; r++) W = i[r], (o = ir(W.data.target, W.event)).id > 0 && ((a = [W.time, W.event]).push(o.id), a.push(W.data.x), a.push(W.data.y), void 0 !== W.data.id && (a.push(W.data.id), void 0 !== W.data.isPrimary && a.push(W.data.isPrimary.toString())), kr(a), _(W.event, W.data.x, W.data.y));
                        rn();
                        break;
                    case 9:
                        for (u = 0, c = Ae; u < c.length; u++) W = c[u], l = ir(W.data.target, W.event, W.data.text), a = [W.time, W.event], d = l.hash ? l.hash.join(".") : "", a.push(l.id), a.push(W.data.x), a.push(W.data.y), a.push(W.data.eX), a.push(W.data.eY), a.push(W.data.button), a.push(W.data.reaction), a.push(W.data.context), a.push(y(W.data.text, "click", l.privacy)), a.push(b(W.data.link)), a.push(d), a.push(W.data.trust), kr(a), lr(W.time, W.event, d, W.data.x, W.data.y, W.data.reaction, W.data.context);
                        He();
                        break;
                    case 38:
                        for (f = 0, h = We; f < h.length; f++) W = h[f], a = [W.time, W.event], (P = ir(W.data.target, W.event)).id > 0 && (a.push(P.id), a.push(W.data.action), kr(a));
                        Ye();
                        break;
                    case 11:
                        p = Je, a.push(p.width), a.push(p.height), _(t, p.width, p.height), ln(), kr(a);
                        break;
                    case 26:
                        v = Mn, a.push(v.name), Cn(), kr(a);
                        break;
                    case 27:
                        for (g = 0, m = Ue; g < m.length; g++) W = m[g], w = ir(W.data.target, W.event, W.data.value), (a = [W.time, W.event]).push(w.id), a.push(y(W.data.value, "input", w.privacy, !1, W.data.type)), kr(a);
                        Be();
                        break;
                    case 21:
                        (k = bn) && (S = ir(k.start, t), E = ir(k.end, t), a.push(S.id), a.push(k.startOffset), a.push(E.id), a.push(k.endOffset), On(), kr(a));
                        break;
                    case 10:
                        for (O = 0, M = dn; O < M.length; O++) W = M[O], N = ir(W.data.target, W.event), T = ir(W.data.top, W.event), x = ir(W.data.bottom, W.event), I = (null == T ? void 0 : T.hash) ? T.hash.join(".") : "", D = (null == x ? void 0 : x.hash) ? x.hash.join(".") : "", N.id > 0 && ((a = [W.time, W.event]).push(N.id), a.push(W.data.x), a.push(W.data.y), a.push(I), a.push(D), kr(a), _(W.event, W.data.x, W.data.y, W.time));
                        dn = [], fn = null, hn = null;
                        break;
                    case 42:
                        for (j = 0, A = _e; j < A.length; j++) W = A[j], a = [W.time, W.event], (P = ir(W.data.target, W.event)).id > 0 && ((a = [W.time, W.event]).push(P.id), a.push(W.data.type), a.push(y(W.data.value, "change", P.privacy)), a.push(y(W.data.checksum, "checksum", P.privacy)), kr(a));
                        Ce();
                        break;
                    case 39:
                        for (R = 0, L = Tn; R < L.length; R++) W = L[R], a = [W.time, W.event], (P = ir(W.data.target, W.event)).id > 0 && (a.push(P.id), kr(a));
                        _n();
                        break;
                    case 22:
                        for (z = 0, H = cr; z < H.length; z++) W = H[z], (a = [W.time, W.event]).push(W.data.type), a.push(W.data.hash), a.push(W.data.x), a.push(W.data.y), a.push(W.data.reaction), a.push(W.data.context), kr(a, !1);
                        sr();
                        break;
                    case 28:
                        X = Nn, a.push(X.visible), kr(a), C(n, X.visible), jn()
                }
                return [2]
            }))
        }))
    ...
    var dr, fr, hr, pr, vr, gr = 0,
        mr = 0,
        yr = null,
        br = 0;

    function wr() {
        pr = !0, gr = 0, mr = 0, br = 0, dr = [], fr = [], hr = {}, vr = null
    }
    ...
    function kr(t, e) {
        if (void 0 === e && (e = !0), pr) {
            ...
            n - br > 2 * i && (q(yr), yr = null), e && null === yr && (25 !== a && B(), yr = Y(Er, i), br = n, $r(mr))
        }
    }

    function Sr() {
        q(yr), Er(!0), gr = 0, mr = 0, br = 0, dr = [], fr = [], hr = {}, vr = null, pr = !1
    }
    ...
    function Er(t) {
        return void 0 === t && (t = !1), rt(this, void 0, void 0, (function() {
            ...
            return it(this, (function(l) {
                switch (l.label) {
                    case 0:
                        return yr = null, (e = !1 === o.lean && mr > 0 && (mr < 1048576 || ji.sequence > 0)) && X(1, 1), $a(),
                            function() {
                                var t = [];
                                cr = [];
                            ...
                            }(), n = !0 === t, a = JSON.stringify(Li(n)), r = "[".concat(fr.join(), "]"), i = e ? "[".concat(dr.join(), "]") : "", u = function(t) {
                    ...
                    case 2:
                        s = l.sent(), l.label = 3;
                    case 3:
                        return W(2, (c = s) ? c.length : u.length), Or(u, c, ji.sequence, n), fr = [], e && (dr = [], mr = 0, gr = 0), [2]
                }
            }))
        }))
    }
    ...
    function Mr(t, e) {
        var n = hr[e];
        t && 4 === t.readyState && n && ((t.status < 200 || t.status > 208) && n.attempts <= 1 ? t.status >= 400 && t.status < 500 ? ti(6) : (0 === t.status && (o.upload = o.fallback ? o.fallback : o.upload), Or(n.data, null, e)) : (vr = {
            sequence: e,
            attempts: n.attempts,
            status: t.status
        ...
        }(t.responseText), 0 === t.status && (Or(n.data, null, e, !0), ti(3)), t.status >= 200 && t.status <= 208 && Nr(e), delete hr[e]))
    }
    ...
    function _r(t) {
        var e = t.error || t;
        return e.message in xr || (xr[e.message] = 0), xr[e.message]++ >= 5 || e && e.message && (Tr = {
            message: e.message,
            line: t.lineno,
            column: t.colno,
            stack: e.stack,
    ...
    function Ir(t) {
        return rt(this, void 0, void 0, (function() {
            ...
            return it(this, (function(n) {
                switch (e = [s(), t], t) {
                    case 31:
                        e.push(Tr.message), e.push(Tr.line), e.push(Tr.column), e.push(Tr.stack), e.push(b(Tr.source)), kr(e);
                        break;
                    case 33:
                        Cr && (e.push(Cr.code), e.push(Cr.name), e.push(Cr.message), e.push(Cr.stack), e.push(Cr.severity), kr(e, !1));
                        break;
                    case 41:
                        Et && (e.push(Et.id), e.push(Et.target), e.push(Et.checksum), kr(e, !1))
                }
                return [2]
            }))
        }))
    ...
    function Yr(t) {
        try {
            ...
            for (var o in Pr[a] = {}, zr[a] = {}, Hr[a] = {}, Wr[a] = r, i) {
                var u = parseInt(o),
                    c = i[o],
                    s = 2;
    ...
    function Vr(t, e, n) {
        var a, r = !1;
        t in Rr || (Rr[t] = {}, r = !0), a = Hr[t], 0 == Object.keys(a).length || e in Rr[t] && Rr[t][e] == n || (r = !0), Rr[t][e] = n, r && Lr.add(t)
    }
    ...
    function Zr(t) {
        ...
        switch (t) {
            case 4:
                var n = M;
                n && ((e = [n.time, n.event]).push(n.data.visible), e.push(n.data.docWidth), e.push(n.data.docHeight), e.push(n.data.screenWidth), e.push(n.data.screenHeight), e.push(n.data.scrollX), e.push(n.data.scrollY), e.push(n.data.pointerX), e.push(n.data.pointerY), e.push(n.data.activityTime), e.push(n.data.scrollTime), kr(e, !1)), x();
                break;
            case 25:
                e.push(L.gap), kr(e);
                break;
            case 35:
                e.push(Ar.check), kr(e, !1);
                break;
            case 3:
                e.push(et.key), kr(e);
                break;
    ...
    function $r(t) {
        if (0 === Ar.check) {
            var e = Ar.check;
            e = ji.sequence >= 128 ? 1 : e, e = ji.pageNum >= 128 ? 7 : e, e = s() > 72e5 ? 2 : e, (e = t > 10485760 ? 2 : e) !== Ar.check && ti(e)
        }
    }

    function ti(t) {
        Ar.check = t, 5 !== t && (ki(), _o())
    }
    ...
    function gi() {
        ...
        var s, l = function() {
            ...
            sessionId: l.session,
            pageNum: l.count
        }, o.lean = o.track && null !== l.upgrade ? 0 === l.upgrade : o.lean, o.upload = o.track && "string" == typeof o.upload && l.upload && l.upload.length > "https://".length ? l.upload : o.upload, ci(0, a), ci(3, c), ci(1, b(location.href, !!pi)), ci(2, document.referrer), ci(15, function() {
            var t = Ni();
    ...
    function mi() {
        vi = null, fi = null, hi.forEach((function(t) {
            t.called = !1
        }))
    }
    ...
    function yi(t, e, n) {
        ...
        var a = o.lean ? 0 : 1,
            r = !1;
        fi && (a || !1 === e) && (t(fi, !o.lean), r = !0), !n && r || hi.push({
            callback: t,
            wait: e,
            recall: n,
            called: r
    ...
    function wi(t) {
        if (void 0 === t && (t = !0), !t) return o.track = !1, Ci("_clsk", "", -Number.MAX_VALUE), Ci("_clck", "", -Number.MAX_VALUE), _o(), void window.setTimeout(xo, 250);
        to() && (o.track = !0, Mi(xi(), 1), Ei(), di(2))
    }
        ...
        ! function(t) {
            if (hi.length > 0)
                for (var e = 0; e < hi.length; e++) {
                    var n = hi[e];
                    !n.callback || n.called || n.wait && !t || (n.callback(fi, !o.lean), n.called = !0, n.recall || (hi.splice(e, 1), e--))
                }
        }(o.lean ? 0 : 1)
    }
    ...
    function Li(t) {
        return ji.start = ji.start + ji.duration, ji.duration = s() - ji.start, ji.sequence++, ji.upload = t && "sendBeacon" in navigator ? 1 : 0, ji.end = t ? 1 : 0, ji.applicationPlatform = 0, ji.url = b(location.href, !1, !0), [ji.version, ji.sequence, ji.start, ji.duration, ji.projectId, ji.userId, ji.sessionId, ji.pageNum, ji.upload, ji.end, ji.applicationPlatform, ji.url]
    }
    ...
    function Hi(t) {
        return function() {
            ...
            W(4, n), n > 30 && (H(7), X(6, n), jr(9, 0, "".concat(t.dn || t.name, "-").concat(n)))
        }
    }
    var Wi = [];
    ...
    function Xi(t, e, n, a) {
        void 0 === a && (a = !1), n = Hi(n);
        try {
            t[u("addEventListener")](e, n, a), Wi.push({
                event: e,
                target: t,
                listener: n,
                capture: a
    ...
    function Bi() {
        return !(Vi++ > 20) || (jr(4, 0), !1)
    }

    function Ji() {
        Vi = 0, Fi !== Ki() && (_o(), window.setTimeout(Gi, 250))
    }
    ...
    function Qi() {
        Zi = !0, c = performance.now() + performance.timeOrigin, ge(), Yi(), Pi(), Fi = Ki(), Vi = 0, Xi(window, "popstate", Ji), null === qi && (qi = history.pushState, history.pushState = function() {
    ...
    function $i() {
        Fi = null, Vi = 0, Pi(), Yi(), ge(), c = 0, Zi = !1
    }
    ...
    function eo() {
        xo(), R("clarity", "restart")
    }

    function no() {
        ! function() {
            Ot = [], X(26, navigator.webdriver ? 1 : 0);
            try {
                X(31, window.top == window.self || window.top == window ? 1 : 2)
            } catch (t) {
                X(31, 0)
            }
        }(), Xi(window, "error", _r), xr = {}, Dr = {}
    }
    eo.dn = 2, no.dn = 3;
        ...
        return rt(this, void 0, void 0, (function() {
            ...
            return it(this, (function(n) {
                switch (n.label) {
                    ...
                    case 1:
                        return n.sent(), Oa(document, t), [4, Xa(5, e, t)];
                    case 2:
    ...
    function io() {
        Te(), xe(), ar(), Ka = null, Va = new WeakMap, Ba = {}, Ja = [], Ga = !!window.IntersectionObserver, Ft(), o.delayDom ? Xi(window, "load", (function() {
                Qn()
            })) : Qn(), me(ro, 1).then((function() {
                Hi(xe)(), Hi($a)(), Hi(yn)()
                ...
                return to() && (X(36, 1), this[wa] === fi.pageNum && Na(s(), this[ba], 1, arguments[0])), ma.apply(this, arguments)
            }), null === ya && (ya = CSSStyleSheet.prototype.replaceSync, CSSStyleSheet.prototype.replaceSync = function() {
                return to() && (X(36, 1), this[wa] === fi.pageNum && Na(s(), this[ba], 2, arguments[0])), ya.apply(this, arguments)
            })),
            function() {
        ...
        stop: function() {
            ar(), Va = null, Ba = {}, Ja = [], Ka && (Ka.disconnect(), Ka = null), Ga = !1, Vt(),
                function() {
                    ...
                    zn = [], Kn = {}, Hn = [], Wn = [], Vn = [], Gn = 0, Bn = null, Zn = 0
                }(), Te(), ka = {}, Sa = {}, Ea = [], Ma(), Pa()
        }
    });
    var uo = null;
        ...
        uo = {
            ...
            function(t) {
                rt(this, void 0, void 0, (function() {
                    var e, n;
                    return it(this, (function(a) {
                        return e = s(), n = [e, t], 29 === t && (n.push(uo.fetchStart), n.push(uo.connectStart), n.push(uo.connectEnd), n.push(uo.requestStart), n.push(uo.responseStart), n.push(uo.responseEnd), n.push(uo.domInteractive), n.push(uo.domComplete), n.push(uo.loadEventStart), n.push(uo.loadEventEnd), n.push(uo.redirectCount), n.push(uo.size), n.push(uo.type), n.push(uo.protocol), n.push(uo.encodedSize), n.push(uo.decodedSize), co(), kr(n)), [2]
                    }))
                }))
            }(29)
    }
    var lo, fo = 0,
        ...
        bo = function() {
            if (!go.length) return -1;
            var t = Math.min(go.length - 1, Math.floor((yo() - vo) / 50));
            return go[t].latency
        },
        wo = function() {
            vo = yo(), go.length = 0, mo.clear()
        },
        ko = function(t) {
            if (t.interactionId && !(t.duration < 40)) {
                ! function(t) {
                    "interactionCount" in performance ? fo = performance.interactionCount : t.interactionId && (ho = Math.min(ho, t.interactionId), po = Math.max(po, t.interactionId), fo = po ? (po - ho) / 7 + 1 : 0)
                }(t);
    ...
    function Eo() {
        try {
            lo && lo.disconnect(), lo = new PerformanceObserver(Hi(Oo));
            for (var t = 0, e = So; t < e.length; t++) {
                var n = e[t];
                PerformanceObserver.supportedEntryTypes.indexOf(n) >= 0 && ("layout-shift" === n && W(9, 0), lo.observe({
                    type: n,
                    buffered: !0
                }))
            }
        ...
        ! function(t) {
            for (var e = (!("visibilityState" in document) || "visible" === document.visibilityState), n = 0; n < t.length; n++) {
                ...
                switch (a.entryType) {
                    ...
                    case "resource":
                        var r = a.name;
                        ci(4, Mo(r)), r !== o.upload && r !== o.fallback || X(28, a.duration);
                        break;
                    case "longtask":
                        H(7);
                        break;
                    case "first-input":
                        ...
                        break;
                    case "event":
                        e && "PerformanceEventTiming" in window && "interactionId" in PerformanceEventTiming.prototype && (ko(a), ci(37, bo().toString()));
                        break;
                    case "layout-shift":
    ...
    function No() {
        co(),
            function() {
                navigator && "connection" in navigator && ci(27, navigator.connection.effectiveType), window.PerformanceObserver && PerformanceObserver.supportedEntryTypes ? "complete" !== document.readyState ? Xi(window, "load", Y.bind(this, Eo, 0)) : Eo() : jr(3, 0)
            }()
    }
    Eo.dn = 26, Oo.dn = 27, No.dn = 25;
    var To = [ao, oo, Ln, Object.freeze({
        __proto__: null,
        start: No,
        stop: function() {
            lo && lo.disconnect(), lo = null, wo(), co()
        }
    })];
    ...
    function xo(t) {
        void 0 === t && (t = null),
            ...
            }(t), Qi(), wt(), To.forEach((function(t) {
                return Hi(t.start)()
            })), null === t && jo())
    }

    function _o() {
        to() && (To.slice().reverse().forEach((function(t) {
            return Hi(t.stop)()
        })), kt(), $i(), void 0 !== Co && (Co[Do] = function() {
            (Co[Do].q = Co[Do].q || []).push(arguments), "start" === arguments[0] && Co[Do].q.unshift(Co[Do].q.pop()) && jo()
        }))
    }
    var Io = Object.freeze({
            ...
            metadata: yi,
            pause: function() {
                to() && (R("clarity", "pause"), null === pe && (pe = new Promise((function(t) {
                    ve = t
                }))))
            },
            resume: function() {
                to() && (pe && (ve(), pe = null, null === he && ye()), R("clarity", "resume"))
            },
            set: ut,
            signal: function(t) {
                mt = t
    ...
    function jo() {
        if (void 0 !== Co) {
            if (Co[Do] && Co[Do].v) return console.warn("Error CL001: Multiple Clarity tags detected.");
            var t = Co[Do] && Co[Do].q || [];
            for (Co[Do] = function(t) {
                    for (var e = [], n = 1; n < arguments.length; n++) e[n - 1] = arguments[n];
                    return Io[t].apply(Io, e)
                }, Co[Do].v = l; t.length > 0;) Co[Do].apply(Co, t.shift())
        }
    }
    jo()
}();